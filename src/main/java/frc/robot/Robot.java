...
//Pneumatic Code
  ...
  private final PneumaticHub pHub = new PneumaticHub(19);
  private final Compressor m_compressor = new Compressor(19,PneumaticsModuleType.CTREPCM);
  private final Solenoid s1 = new Solenoid(19,PneumaticsModuleType.CTREPCM, 0);
  private final Solenoid s2 = new Solenoid(19,PneumaticsModuleType.CTREPCM,7);
  ...
  public void autonomousPeriodic() {
    // if (m_robotContainer.m_chooser.getSelected() == m_midAutonCommand) {
      ...
      //   }
      // }
      // if ((time1.get() > 13.5 && time1.get() < 14) && encoder.getDistance() > 135) {
      //   index1.set(1);
      //   index2.set(1);
      //   leftArm.stopMotor();
      //   rightArm.stopMotor();
